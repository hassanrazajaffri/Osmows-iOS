...
NSString *const kNetworkReachabilityChangedNotification = @"kReachabilityChangedNotification";
...
+(BOOL)isConnected{
    NetworkReachability *reachability = [NetworkReachability reachabilityForInternetConnection];
