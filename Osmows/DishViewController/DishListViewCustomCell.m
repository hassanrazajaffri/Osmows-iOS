...
@implementation CategoriesLisrViewCustomCell
- (void)awakeFromNib {
    // Initialization code
}
...
+(CategoriesLisrViewCustomCell*) createCell {
    CategoriesLisrViewCustomCell *cell = [[[NSBundle mainBundle]loadNibNamed:@"CategoriesLisrViewCustomCell" owner:self options:nil]lastObject];
