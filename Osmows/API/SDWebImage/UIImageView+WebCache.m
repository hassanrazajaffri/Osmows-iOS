...
//                    NSString *localFilePath = [documentsDirectory stringByAppendingPathComponent:myString];
//                    NSData *thedata = [NSData dataWithContentsOfURL:imageURL];
//                    [thedata writeToFile:localFilePath atomically:YES];
//                    NSString *myString1 = [imageURL absoluteString];
//                    [[SDImageCache sharedImageCache] storeImage:image forKey:myString1];
...
//                    NSData *thedata = [NSData dataWithContentsOfURL:imageURL];
//                    [thedata writeToFile:localFilePath atomically:YES];
//                     [[SDImageCache sharedImageCache] storeImage:image forKey:myString];
                    wself.image = image;
